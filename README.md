# 👋 Hi, I’m Ronel Solomon (@ronelsolomon)

I'm a **Data & ML Engineer** passionate about building scalable data platforms, automating ML pipelines, and enabling cross-functional teams through high-quality data solutions.

---

## 👀 I’m interested in:
- Scalable data engineering & real-time analytics platforms (Kafka, Flink)
- Generative AI, agentic/multi-agent systems, & LLM-powered workflows
- GenAI video generation (ComfyUI, AnimateDiff) & load-balanced AI video pipelines
- AI Engineering: Fine-tuning LLMs (Mistral, Llama) for production RAG/agents
- Medical AI agents & multimodal health diagnostics (e.g., audio-based detection)
- Secure, cloud-native ML infra (Azure, AWS, GCP) & open-source AI Ops tooling
...
🔧 Python | SQL | TypeScript | Java | PySpark
🤖 Hugging Face | Llama | OpenAI GPT | LangChain
☁️ Azure | AWS | GCP | Kubernetes | Docker
📊 Spark | Airflow | Kafka | MongoDB | Firestore
📈 Power BI | Tableau


## 📫 How to reach me:
- 📧 ronelsolomon@gmail.com
- 🔗 [LinkedIn](https://www.linkedin.com/in/ronel-solomon/)
- 🖥️ [Medium Article](https://medium.com/@ronelsolomon)

## ⚡ Fun fact:
Before diving into big data and machine learning, I built dashboards to detect fraud and optimize physical workspace security. I also love turning research papers into working prototypes for fun!

---

> “Enabling intelligent systems starts with trustworthy data.”

<!---
ronelsolomon/ronelsolomon is a ✨ special ✨ repository because its `README.md` (this file) appears on your GitHub profile.
--->
